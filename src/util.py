...
from configuration_llava import HMEConfig
...
def get_frg_list(vocab_file: str = "./vocab_800_other_tasks.txt") -> List[str]:
...
def load_hme(
    ...
    """
    frg_tokens = get_frg_list() if add_frg_vocab else []
