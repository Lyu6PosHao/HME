#!/usr/bin/python
# -*- coding:utf-8 -*-
#the main function is used to generate vocab, and other functions are called by other scripts
import sys
# sys.path.append("/path/to/HME/src/psvae/")
...
def parse():
    ...
    parser.add_argument('--data', type=str, help='Path to molecule corpus',default='')
    parser.add_argument('--vocab_size', type=int, default=800, help='Length of vocab')
    parser.add_argument('--output', type=str, help='Path to save vocab',default='')
    parser.add_argument('--workers', type=int, default=128, help='Number of cpus to use')
    parser.add_argument('--kekulize', action='store_false', help='Whether to kekulize the molecules (i.e. replace aromatic bonds with alternating single and double bonds)')
