...
BASE_MODEL="HME_description-based-molecular-generation_pretrain_merged"
LORA_R=16
LORA_ALPHA=32
...
DATA_TYPE="1d,frg"
DATA_PATH="../datasets/desc2mol_train.json"
MOL_EMB_PATH="none"
...
OUTPUT_DIR="../checkpoints/HME_description-based-molecular-generation"
mkdir -p "$OUTPUT_DIR"
cp "$0" "${OUTPUT_DIR}/"
